...
EXPORTNUM(95)
[[noreturn]] DLLEXPORT VOID XBOXAPI KeBugCheck(
	ULONG BugCheckCode);

EXPORTNUM(96)
[[noreturn]] DLLEXPORT VOID XBOXAPI KeBugCheckEx(
	ULONG     BugCheckCode,
...
EXPORTNUM(103)
DLLEXPORT KIRQL XBOXAPI KeGetCurrentIrql();

EXPORTNUM(105)
DLLEXPORT VOID XBOXAPI KeInitializeApc(
	PKAPC             Apc,
	PKTHREAD          Thread,
	PKKERNEL_ROUTINE  KernelRoutine,
	PKRUNDOWN_ROUTINE RundownRoutine,
...
EXPORTNUM(107)
DLLEXPORT VOID XBOXAPI KeInitializeDpc(
	PKDPC              Dpc,
	PKDEFERRED_ROUTINE DeferredRoutine,
	PVOID              DeferredContext);

EXPORTNUM(112)
DLLEXPORT VOID XBOXAPI KeInitializeSemaphore(
	PKSEMAPHORE Semaphore,
	LONG        Count,
	LONG        Limit);

EXPORTNUM(113)
DLLEXPORT VOID XBOXAPI KeInitializeTimerEx(
	PKTIMER    Timer,
	TIMER_TYPE Type);

EXPORTNUM(129)
DLLEXPORT KIRQL XBOXAPI KeRaiseIrqlToDpcLevel();

EXPORTNUM(156)
DLLEXPORT extern volatile DWORD KeTickCount;

EXPORTNUM(161)
DLLEXPORT VOID FASTCALL KfLowerIrql(
	KIRQL NewIrql);

EXPORTNUM(321)
DLLEXPORT extern XBOX_KEY_DATA XboxEEPROMKey;
